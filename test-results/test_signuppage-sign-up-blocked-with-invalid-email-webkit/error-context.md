...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Sign up' })
    9 × locator resolved to <button type="submit" class="btn btn-lg btn-primary pull-xs-right"> Sign up </button>
...
- generic [ref=e2]:
  ...
  - contentinfo [ref=e33]:
    - generic [ref=e34]:
      - link "Conduit" [ref=e35]:
        - /url: /
        - img "Conduit" [ref=e36]
      - generic [ref=e37]:
        - text: © 2026. An interactive learning project from
        - link "RealWorld OSS Project" [ref=e38]:
